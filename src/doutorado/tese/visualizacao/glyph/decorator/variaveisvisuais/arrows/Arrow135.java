...
//        g2d.draw(p);    
        ...
        int[] line1 = new int[4];
        line1[0]=bounds.x+bounds.width;
        line1[1]=bounds.y+2*slice;
        line1[2]=bounds.x+bounds.width-2*slice;
        line1[3]=bounds.y;
        
        int[] line2 = new int[4];
        line2[0]=bounds.x+bounds.width;
        line2[1]=bounds.y+4*slice;
        line2[2]=bounds.x+bounds.width-4*slice;
        line2[3]=bounds.y;
        
        int[] line3 = new int[4];
        line3[0]=bounds.x+bounds.width;
        line3[1]=bounds.y+bounds.height;
        line3[2]=bounds.x;
        line3[3]=bounds.y;
        
        int[] line4 = new int[4];
        line4[0]=bounds.x+bounds.width-2*slice;
        line4[1]=bounds.y+bounds.height;
        line4[2]=bounds.x;
        line4[3]=bounds.y+2*slice;
        
        int[] line5 = new int[4];
        line5[0]=bounds.x+bounds.width-4*slice;
...
//            
        ...
        while(x<= bounds.x+bounds.width){
            ...
            p = new Polygon();
            p.addPoint(bounds.x+bounds.width-x, bounds.y );
            //top
            p.addPoint((int) (bounds.x+bounds.width-x+scalewidth*1.25), (int) (bounds.y+scaleheight*0.7));
            //botton
            p.addPoint((int) (bounds.x+bounds.width-x+scalewidth*0.6), (int) (bounds.y+scaleheight*1.4));
        ...
        while(y<bounds.y+bounds.height){
            ...
            p = new Polygon();
            p.addPoint(bounds.x,bounds.y+y);
            //top
            p.addPoint((int) (bounds.x+scalewidth*1.25), (int) (bounds.y+y+scaleheight*0.7));
            //botton
            p.addPoint((int) (bounds.x+scalewidth*0.6), (int) (bounds.y+y+scaleheight*1.4));
